...
const COPY = {
  "zh-Hant": {
    ready: "本卷使用的生辰",
    auto: "分析已依同一份生辰自動完成",
    missing: "尚未找到生辰資料。回首頁填寫一次，七份命理專卷即可共用。",
    edit: "回首頁修改生辰",
    add: "回首頁填寫生辰",
    back: "返回七種專卷",
    overview: "本卷總覽",
  ...
  "zh-Hans": {
    ready: "本卷使用的生辰",
    auto: "分析已依同一份生辰自动完成",
    missing: "尚未找到生辰资料。回首页填写一次，七份命理专卷即可共用。",
    edit: "回首页修改生辰",
    add: "回首页填写生辰",
    back: "返回七种专卷",
    overview: "本卷总览",
  ...
  en: {
    ...
    missing: "No birth record yet. Add it once on the homepage and all seven specialist readings can reuse it.",
    edit: "Edit birth record",
    add: "Add birth record",
    back: "Back to seven readings",
