    ...
    return (
      <article className="rounded-2xl border border-[#b99755]/35 bg-[#fffaf2] p-5" data-d60-minute-gate>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            type="button"
            className="rounded-xl bg-ink px-4 py-3 text-sm font-semibold text-paper"
            aria-label={`${copy.confirm}（${String(reportBirth.hour).padStart(2, "0")}:${String(reportBirth.minute).padStart(2, "0")}）`}
            onClick={() => setConfirmedKey(key)}
          >
            {copy.confirm}
          </button>
