...
const COPY = {
  "zh-Hant": {
    kicker: "昭梧圖庫 · 個人命誥母圖",
    title: "你的命誥圖",
    note: "先依本次命盤，從站主核准的個人命誥圖庫匹配母圖，再據此生成你的個人版本。圖像只負責視覺呈現，不反向改動命理判斷。",
    generate: "生成個人命誥圖",
    generating: "命誥圖生成中…",
    matched: "匹配母圖",
    generated: "你的成圖",
    unavailable: "目前沒有可用的核准命誥母圖，暫不啟動生成。",
    alt: "昭梧核准命誥圖庫參考圖",
  ...
  "zh-Hans": {
    kicker: "昭梧图库 · 个人命诰母图",
    title: "你的命诰图",
    note: "先依本次命盘，从站主核准的个人命诰图库匹配母图，再据此生成你的个人版本。图像只负责视觉呈现，不反向改动命理判断。",
    generate: "生成个人命诰图",
    generating: "命诰图生成中…",
    matched: "匹配母图",
    generated: "你的成图",
    unavailable: "目前没有可用的核准命诰母图，暂不启动生成。",
    alt: "昭梧核准命诰图库参考图",
    generatedAlt: "昭梧个人命诰图",
  },
  en: {
    kicker: "ZHAOWU GALLERY · PERSONAL VISUAL SOURCE",
    title: "Your decree image",
    note: "First match an owner-approved visual reference from the personal gallery, then generate your version from that reference. The image never changes the reading itself.",
    generate: "Generate my decree image",
    generating: "Generating decree image…",
    matched: "Matched reference",
    generated: "Your image",
    unavailable: "No approved decree reference is available, so generation is paused.",
    alt: "Owner-approved Zhaowu decree reference",
