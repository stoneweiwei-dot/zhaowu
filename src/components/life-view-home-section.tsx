...
const ARTICLES = [THREE_AGES_SPIRITUAL_WORLD_LONG_FORM, THREE_TEACHINGS_CULTIVATION_LONG_FORM, ...LIFE_VIEW_LONG_FORM_ARTICLES, ...LIFE_VIEW_SHORT_FORM_ARTICLES, ...LIFE_VIEW_CURATED_ARTICLES];
