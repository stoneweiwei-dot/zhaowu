...
function UpdatesPage() {
  ...
  const englishSummary = "Public background-music reads now load no Git or SSH write runtime at all; those dependencies are evaluated only for owner write actions."
