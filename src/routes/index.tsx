  ...
  return (
    <main className="space-y-6 sm:space-y-10">
      <section className="zhaowu-home-hero px-5 py-7 sm:px-10 sm:py-14" aria-labelledby="zhaowu-title">
        <img src="/emblems/crane-feather-emblem.svg" alt="" aria-hidden className="zhaowu-emblem zhaowu-home-hero-emblem zhaowu-home-hero-emblem-a" />
        <img src="/emblems/lotus-emblem.svg" alt="" aria-hidden className="zhaowu-emblem zhaowu-home-hero-emblem zhaowu-home-hero-emblem-b" />
        <img src="/emblems/modern-gourd-emblem.svg" alt="" aria-hidden className="zhaowu-emblem zhaowu-home-hero-emblem zhaowu-home-hero-emblem-c" />
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="mt-4 max-w-xl pr-10 font-display text-xl font-semibold leading-[1.5] tracking-[0.08em] text-wood sm:mt-7 sm:pr-0 sm:text-3xl sm:leading-[1.55] sm:tracking-[0.1em]">
            {t("heroSlogan")}
          </p>
          <p className="mt-2 max-w-xl pr-8 font-serif text-[11px] italic leading-5 tracking-[0.08em] text-water/70 sm:mt-3 sm:pr-0 sm:text-xs sm:tracking-[0.12em]">{t("heroEnglish")}</p>
          ...
          <p className="max-w-xl pr-6 font-display text-sm leading-7 tracking-[0.03em] text-ink sm:pr-0 sm:text-lg sm:leading-8 sm:tracking-[0.04em]">{t("heroLead")}</p>
          <p className="mt-3 hidden max-w-xl text-sm leading-7 text-ink-soft sm:block">{t("heroBody")}</p>
          <p className="mt-5 hidden w-fit border-y border-earth/30 py-2 font-display text-xs tracking-[0.24em] text-earth sm:block">{t("heroSign")}</p>
