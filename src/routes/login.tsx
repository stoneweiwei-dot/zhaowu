...
function LoginPage() {
  ...
  return (
    <main className="stone-login-screen" aria-labelledby="login-title" data-owner-only-login="true" data-login-backend="vercel-owner-cookie" data-login-surface="cinematic-r182">
      <LoginStageBackdrop />
