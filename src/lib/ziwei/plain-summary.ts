...
const HANS_MAP: Record<string, string> = {
  裡:'里',這:'这',個:'个',會:'会',讓:'让',來:'来',說:'说',與:'与',為:'为',對:'对',過:'过',開:'开',還:'还',點:'点',業:'业',財:'财',關:'关',係:'系',壓:'压',態:'态',選:'选',擇:'择',實:'实',現:'现',適:'适',長:'长',變:'变',轉:'转',穩:'稳',發:'发',間:'间',邊:'边',際:'际',較:'较',經:'经',驗:'验',價:'价',體:'体',慮:'虑',務:'务',責:'责',權:'权',認:'认',後:'后',話:'话',進:'进',處:'处',學:'学',習:'习',顯:'显',環:'环',質:'质',復:'复',斷:'断',線:'线',願:'愿',應:'应',該:'该',屬:'属',標:'标',準:'准',維:'维',護:'护',總:'总',結:'结',簡:'简',單:'单',專:'专',門:'门',從:'从',內:'内',歲:'岁',當:'当',時:'时',將:'将',無:'无',種:'种',給:'给',別:'别',
  腦:'脑',觀:'观',決:'决',優:'优',見:'见',擔:'担',撐:'撑',場:'场',產:'产',資:'资',條:'条',談:'谈',順:'顺',暢:'畅',衝:'冲',親:'亲',確:'确',彈:'弹',誠:'诚',勝:'胜',續:'续',揮:'挥',氣:'气',細:'细',緒:'绪',銳:'锐',東:'东',靜:'静',動:'动',調:'调',劃:'划',錢:'钱',戶:'户',項:'项',團:'团',隊:'队',職:'职',創:'创',積:'积',鮮:'鲜',曖:'暧',臨:'临',篩:'筛',脈:'脉',數:'数',輩:'辈',傳:'传',議:'议',題:'题',戰:'战',強:'强',繼:'继',協:'协',尋:'寻',詢:'询',層:'层',確:'确',驗:'验',證:'证',將:'将',體:'体',佈:'布',據:'据',寫:'写',讀:'读',顧:'顾',辦:'办',壘:'垒',鬧:'闹',愛:'爱',仍:'仍',與:'与',並:'并',採:'采',構:'构',築:'筑',帶:'带',啟:'启',實:'实',現:'现',網:'网',擴:'扩',縮:'缩',風:'风',險:'险',節:'节',節:'节',徑:'径',壞:'坏',運:'运',產:'产',賴:'赖',顯:'显',遲:'迟',儘:'尽',儲:'储',觀:'观',覽:'览',語:'语',則:'则',隨:'随',樂:'乐',區:'区',佔:'占',讓:'让',盡:'尽'
};
