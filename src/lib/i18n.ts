...
const TABLE = {
  ...
  full: ["白話完整報告", "白话完整报告"],
  genFull: ["查看完整九頁報告", "查看完整九页报告"],
  generating: ["正在整理完整九頁報告…", "正在整理完整九页报告…"],
  ...
  withApple: ["使用 Apple 繼續", "使用 Apple 继续"],
  withX: ["使用 X 繼續", "使用 X 继续"],
  orEmail: ["或使用 Email", "或使用 Email"],
  backHome: ["返回首頁", "返回首页"],
...
const EN: Record<CopyKey, string> = {
  ...
  genFull: "View the full nine-page report",
  generating: "Building the nine-page report…",
