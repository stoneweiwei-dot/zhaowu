...
export const SITE_RELEASE_FALLBACK = {
  ...
  updateNumber: 191,
  publishedAt: "2026-09-24T11:20:00+10:00",
  ...
  details: {
    ...
    en: [
      "The official site now uses the Lite-inspired 560px mobile reading measure and quieter paper/jade/cinnabar presentation while keeping one canonical full-analysis core.",
