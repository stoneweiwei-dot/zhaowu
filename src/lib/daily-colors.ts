  ...
  },
  {
    ...
    copy: {
      "zh-Hant": {
        ...
        description: "用黃、赫、棕把節奏放慢，回到比較穩的位置。這是休息提示，不是必須遵守的穿著律令。",
      ...
      "zh-Hans": {
        ...
        description: "用黄、赫、棕把节奏放慢，回到比较稳的位置。这是休息提示，不是必须遵守的穿着律令。",
        englishExplain: "Kunning · Earth — Rest / Stability / Recovery",
        wantLabel: "想放松",
      },
      en: {
...
export const DAILY_COLOR_PAGE = {
  ...
  "zh-Hans": {
    ...
    back: "返回昭梧",
    pick: "也可以先选你现在要的状态",
    almanacNote: "上方“今日适合”只參考今日日干五行，作为轻量时间提示。",
    userNote: "你随时可以改选自己要的状态，不必跟今日參考走。",
