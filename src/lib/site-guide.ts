...
const COPY: Record<Locale, GuideCopy> = {
  "zh-Hant": {
    analysis: ["要問工作、感情、時機或人生選擇，從首頁的分析表單開始。", "開始八字分析"],
  ...
  "zh-Hans": {
    analysis: ["要问工作、感情、时机或人生选择，从首页的分析表单开始。", "开始八字分析"],
  ...
  en: {
    analysis: ["For work, relationships, timing or a life decision, start with the analysis form on the home page.", "Start BaZi analysis"],
