...
For every ZHAOWU metaphysics analysis, report, AI prompt, rule-ingestion task or specialist route, the current governance doctrine is `docs/STONE-R6.2.2-CURRENT-MASTER.md`. The deterministic runtime it governs remains `docs/STONE-R6.2.1-CURRENT-MASTER.md` together with mandatory runtime patches `docs/STONE-R6.2.1-P2-STRUCTURAL-DYNAMICS.md` and `docs/STONE-R6.2.1-P3-PINKU-BINGYAO-GATE.md`, unless the site owner explicitly approves a later runtime patch. `docs/METAPHYSICS-DEFAULT-PROTOCOL-v1.0.md` is retained only as a historical redirect.
...
7. R6.2.2 is the current governance/evidence layer. Governance and deterministic runtime remain separate; Progressive Execution, Stage Checkpoint, No Silent Reinterpretation, evidence class, baseline, Tie Procedure, Regression Test and Governance Stop Rule are mandatory.
