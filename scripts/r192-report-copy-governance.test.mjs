...
test("r192 customer report does not expose prompt-like dashboard labels", async () => {
...
test("r192 R6.2.2 is governance current while deterministic runtime stays explicit", async () => {
  ...
  assert.match(master, /structure is not a balance sheet/);
});
