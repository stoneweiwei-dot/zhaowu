...
test("client details, BaZi chart and question are visibly independent ordered sections", async () => {
  ...
  assert.match(form, /id="question-stage" className="zhaowu-question-sheet/);
