...
test("tea portrait uses bundled same-origin art without public Supabase lookup", async () => {
  ...
  assert.doesNotMatch(image, /resolvePrimaryGalleryAssets/);
  assert.doesNotMatch(image, /galleryPublicUrl/);
});
