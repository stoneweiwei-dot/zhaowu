...
test("r192 adopts Lite mobile discipline without creating a second product core", async () => {
  ...
  assert.match(registry, /r192 正式站 × 昭梧 Lite/);
  assert.match(registry, /zhaowu-guide\.ston1004\.chatgpt\.site/);
});

test("r192 preserves the Storage write freeze", async () => {
