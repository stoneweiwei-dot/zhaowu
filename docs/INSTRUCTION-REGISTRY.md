...
- 登入：2026-09-13 最新站主指令再次 supersede r119/r126。普通用戶無登入；唯一 `/login` 改為昭梧獨立站主密碼驗證，身份不經 Supabase Auth。Vercel Serverless 驗證後發 HttpOnly/Secure/SameSite=Strict Owner Cookie；Supabase 只保留資料／Storage 依賴。
