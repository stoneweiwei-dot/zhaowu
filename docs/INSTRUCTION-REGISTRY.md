...
## 2026-09-21 r171 今日色意 supersession

- ACTIVE：原「每日穿衣｜五行色彩」前台產品語意升級為「今日色意」，仍位於首頁「今日指引」內，完整互動指南保留 `/daily-colors`。
- 十四色固定：紅、橘、黃、綠、藍、水藍／藍綠、紫、粉紅、棕、黑、白、灰、金、銀；每色固定輸出「核心象徵／適合現在／什麼時候少一點／今日提醒」。
- 黃曆日干只提供輕量參考：木→綠、火→紅、土→棕、金→金、水→藍。不得稱為喜用神、補五行或個人幸運色。
- 使用者當下狀態與個人色彩記憶優先，可自由改選；Color Magic 無唯一絕對對照表。
- 手機選色必須直式雙欄，不得使用左右拖動的卡片軌道。
- 此模組只屬文化／生活象徵層；不得進入子平結構主判，也不得反向改寫格局、病藥、ODL、FC、承載或歲運判斷。
- 完整契約：`docs/DAILY-COLOR-INTENT.md`。
