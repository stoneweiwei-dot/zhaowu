...
- Loading 改播站主原片飛升動畫 `/intro/owner-immortal-ascent-r123.mp4`（H.264 High、720×1280、24 fps、10.04 秒、約 9.2MB）與同名 JPEG 海報；成功播放時走原時長，右下角提供 Skip，錯誤約 1.6 秒 fail-open，硬退出 12 秒。Playwright `navigator.webdriver` 預設跳過 10 秒 intro，避免 Safari 套件超時。
